...
def update_agents(guid_list,agent_references,db,show):
    db_update = db.cursor()
    db_delete = db.cursor()
    agent_list = []
...
def main():
    ...
    parser.add_argument("--report",action="store_true",dest="report",default=True,help="(default) Creates report of what will be done to the agentIDs")
